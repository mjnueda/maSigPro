...
if(n.groups==1){group=factor(groups, labels=colnames(edesign)[3])}
else group <- factor( as.matrix(edesign[,3:ncol(edesign)])%*%c(1:n.groups), labels=colnames(edesign)[3:ncol(edesign)])
